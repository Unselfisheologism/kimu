...
// Keep the old function signature for backward compatibility during migration
export const legacyApiUrl = (endpoint: string, _fastapi: boolean = false, betterauth: boolean = false): string => {
  return apiUrl(endpoint, betterauth);
};